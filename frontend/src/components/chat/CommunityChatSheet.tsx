...
import { Send, Users, MessageCircle, Bell, CheckCircle } from 'lucide-react';
...
const CommunityChatSheet: React.FC = () => {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    const mockMessages: Message[] = [
      ...
      },
      {
        ...
        userId: '2',
        username: 'Fatima',
        content: 'I recommend starting with Sahih Bukhari, hadiths are very authentic.',
    ...
    const dailyNotifications = [
      ...
      '💡 Tip of the day: Use narrator filter to find hadiths by specific companions',
    ...
    const notificationInterval = setInterval(() => {
      ...
      setNotifications(prev => {
        const updated = [randomNotification, ...prev.slice(0, 4)];
        return updated;
      });
