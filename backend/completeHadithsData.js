// Complete Hadiths Data for All Six Canonical Books
// This file contains authentic hadiths from Sahih al-Bukhari, Sahih Muslim, 
// Sunan Abu Dawud, Jami' at-Tirmidhi, Sunan an-Nasa'i, and Sunan Ibn Majah

export const completeHadithsData = [
  ...
  {
    id: 8,
    arabic: "إِنَّ مِنْ أَشَرِّ النَّاسِ عِنْدَ اللَّهِ مَنْزِلَةً يَوْمَ الْقِيَامَةِ الرَّجُلَ يُدْخِلُهُ عَلَى النَّاسِ الشَّرَّ",
    english: {
      narrator: "Aisha",
      text: "Indeed, among the worst of people in the sight of Allah on the Day of Resurrection will be a man who is intimate with a woman and then spreads her secret."
    },
    reference: {
      book: "Sahih al-Bukhari",
      bookNumber: 67,
    ...
    chapter: "The Book of Marriage",
    category: "marriage",
    difficulty: "advanced",
    tags: ["marriage", "privacy", "ethics"],
    createdAt: new Date(),
    isActive: true
  },
  ...
  {
    id: 13,
    arabic: "إِنَّ لِرَبِّكَ عَلَيْكَ حَقًّا",
    english: {
      narrator: "Abdullah ibn Abbas",
      text: "Verily your Lord has a right over you, and your self has a right over you, and your family has a right over you."
    },
    reference: {
      book: "Sahih Muslim",
      bookNumber: 7,
  ...
  {
    id: 15,
    arabic: "مَنْ أَحْسَنَ صَلَاةَ النَّاسِ فِي أَوَّلِ اللَّيْلِ",
    english: {
      narrator: "Abu Hurairah",
      text: "Whoever performs prayer at the beginning of its time is the one who has performed it perfectly."
    },
    reference: {
      book: "Sunan Abu Dawud",
      bookNumber: 2,
  ...
  {
    id: 17,
    arabic: "لَا تَزُولُ قَدَمَا عَبْدٍ يَوْمَ الْقِيَامَةِ",
    english: {
      narrator: "Abu Hurairah",
      text: "A servant's feet will not move on the Day of Resurrection until he is asked about four things: his life and how he spent it, his youth and how he used it, his wealth and how he earned it and spent it, and his knowledge and what he did with it."
    },
    reference: {
      book: "Sunan Abu Dawud",
      bookNumber: 42,
    ...
    difficulty: "advanced",
    tags: ["accountability", "judgment", "life"],
    createdAt: new Date(),
    isActive: true
  },
  ...
  {
    id: 21,
    arabic: "إِنَّ اللَّهَ يَرْضَى لَكُمْ ثَلَاثًا",
    english: {
      narrator: "Abu Hurairah",
      text: "Indeed, Allah is pleased with three things for you: that you worship Him and not associate anything with Him, that you hold fast to the rope of Allah all together, and that you give sincere counsel to those whom Allah has entrusted to your leaders."
    },
    reference: {
      book: "Jami' at-Tirmidhi",
      bookNumber: 39,
    ...
    chapter: "The Book of Tafsir",
    category: "worship",
    difficulty: "advanced",
    tags: ["worship", "unity", "counsel"],
    createdAt: new Date(),
    isActive: true
  },
  ...
  {
    id: 25,
    arabic: "الْكَبَائِرُ سَبْعٌ",
    english: {
      narrator: "Abu Hurairah",
      text: "The major sins are seven: associating partners with Allah, killing a soul which Allah has forbidden except by right, consuming interest, consuming an orphan's property, fleeing from the battlefield, and slandering chaste, believing women."
    },
    reference: {
      book: "Sunan an-Nasa'i",
      bookNumber: 37,
    ...
    chapter: "The Book of Major Sins",
    category: "sin",
    difficulty: "advanced",
    tags: ["major sins", "prohibitions", "ethics"],
    createdAt: new Date(),
    isActive: true
  },
